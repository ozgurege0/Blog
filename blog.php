...
require_once('includes/navbar.php');
  ...
  <!-- Footer -->
    ...
    <input type="text" class="form-control rounded mt-3" placeholder="Adınız..." name="yorumlar_ad"> 
...
<h2 class="text-center mt-3" >Yorumlar</h2>
          <?php 
  ...
  <div class="card-body">
    <div class="row">
        <div class="col-md-1">
            <img src="https://ui-avatars.com/api/?name=<?php echo $yorumlarcek["yorumlar_ad"] ?>&color=7F9CF5&background=EBF4FF&rounded=true" width="80px">
        </div>
        <div class="col-md-11">
            <p><b classs="mt-3"><?php echo $yorumlarcek["yorumlar_ad"] ?></b></p>
            <p><?php echo $yorumlarcek["yorumlar_icerik"] ?></p>
            </div>
    </div>
  </div>
</div>
